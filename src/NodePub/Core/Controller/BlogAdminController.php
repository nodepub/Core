...
use NodePub\Core\Form\Type\BlogConfigType;
...
class BlogAdminController
{
    ...
    public function dashboardAction()
    {
        ...
        return $this->app['twig']->render('@np-admin/panels/blog.twig', array(
    ...
    public function getPostsAction($page)
    {
        ...
        return $this->app['twig']->render('@np-admin/panels/blog_post_index.twig', array(
    ...
    public function editSettingsAction()
    {
        $form = $this->app['form.factory']
            ->createBuilder(new BlogConfigType())
            ->getForm();
